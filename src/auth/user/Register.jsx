...
const Register = () => {
  ...
  return (
    <>
      <div
        className="min-h-screen flex items-center justify-center bg-[#f2f4f8] p-6"
        style={{
      ...
      >
        <div className="w-full mx-4 sm:mx-auto sm:max-w-md bg-white rounded-2xl p-6 shadow-[0_8px_24px_rgba(0,0,0,0.08)]">
